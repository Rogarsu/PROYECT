...
function validar(){
    ...
    if(document.getElementById('presupuesto').value < 1000000 && document.getElementById('presupuesto').value != 0 || document.getElementById('presupuesto').value >10000000 && document.getElementById('presupuesto').value != 0){
